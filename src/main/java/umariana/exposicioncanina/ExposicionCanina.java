         ...
         System.out.println("4.Localizar perro por nombre");
          ...
          int opcion = sc.nextInt();
                  ...
                  switch(opcion ){
                      ...
                      case 2 -> menuListar();
                      case 3 -> buscarInformacionPerro() ;
                      case 4 -> localizarPerro();
                      case 5 -> buscarPerroMayorPuntaje() ;
                       case 6 -> buscarPerromenorPuntaje();
                             case 7 -> buscarPerroMasViejo();
         ...
         System.out.println("3.Volver al menu principal");
          ...
          int opcion = sc.nextInt();
                  ...
                  switch(opcion ){
                   ...
                   case 1 -> listarPorEdad();
                  case 2 -> listarPorPuntaje();
                  case 3 -> mostrarMenu();
